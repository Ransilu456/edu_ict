...
<head>
  ...
  <title>LogicQuest | A/L ICT Interactive Learning Platform</title>
  <meta name="description" content="Master digital logic, subnetting, and signal encoding for A/L ICT. Interactive simulations, circuit builder, and quiz challenges.">
  <link rel="stylesheet" href="src/css/style.css">
  <link rel="stylesheet" href="src/css/home-view.css">
</head>
...
<body>
  ...
  <!-- ── HEADER ──────────────────────────────────────────────── -->
  <header>
    <!-- Left: Gamified Keys Badge & Controls -->
    <div style="display:flex; align-items:center; gap:0.75rem">
      <div class="header-badge keys" title="Keys Left" style="cursor:help">
        <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" style="color:#a3a198; vertical-align:middle; margin-right:2px"><path d="M7 2a5 5 0 0 0-5 5v3a5 5 0 0 0 4.5 4.97L6.5 22h4v-2h2v-2h2v-2h1.5a5 5 0 0 0 4-4V7a5 5 0 0 0-5-5zm5 5a2 2 0 1 1-2 2 2 2 0 0 1 2-2z"/></svg>
        <span id="keys-count" style="font-family:var(--font-header); font-weight:800">5</span>
      </div>
    </div>

    <!-- Center: Logo with Custom Gates Illustration -->
    <div class="logo" onclick="location.reload()">
      <svg viewBox="0 0 48 32" width="48" height="32" style="vertical-align:middle">
        <!-- Wires -->
        <path d="M8 8 H16 M8 24 H16 M8 16 H14 M26 12 C30 12, 30 20, 34 20" fill="none" stroke="#1cb0f6" stroke-width="2.5" stroke-linecap="round"/>
        <!-- AND Gate (yellow) -->
        <path d="M15 5 H21 A6 6 0 0 1 27 11 V11 A6 6 0 0 1 21 17 H15 Z" fill="#ffd43b" stroke="#e6b800" stroke-width="1.5"/>
        <!-- NOT Gate (purple) -->
        <path d="M33 16 L39 20 L33 24 Z" fill="#8a3ffc" stroke="#6929c4" stroke-width="1.5"/>
        <circle cx="41" cy="20" r="1.5" fill="#8a3ffc" stroke="#6929c4" stroke-width="1.5"/>
        <!-- OR Gate (yellow) -->
        <path d="M15 20 C18 23, 18 25, 15 28 C19 28, 23 26, 25 24 C23 22, 19 20, 15 20 Z" fill="#ffd43b" stroke="#e6b800" stroke-width="1.5"/>
      </svg>
      <span style="font-weight:900">LOGICQUEST</span>
    </div>

    <!-- Right: Navigation, Energy Badge & Settings Controls -->
    <div style="display:flex; align-items:center; gap:1.25rem; flex:1; justify-content:flex-end">

      <!-- Desktop Navigation -->
      <nav class="desktop-nav">
        <button class="nav-tab active" data-target="home-view" title="Home">
        ...
        <button class="nav-tab" data-target="course-map-view" title="Guided Course">
        ...
        <button class="nav-tab" data-target="explorer-view" title="Gate Explorer">
        ...
        <button class="nav-tab" data-target="sandbox-view" title="Sandbox Circuit Builder">
          <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>
          Sandbox
        </button>
        <button class="nav-tab" data-target="subnetting-view" title="Subnetting Master">
          <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
          Subnetting
        </button>
        <button class="nav-tab" data-target="encoder-view" title="Signal Encoding Lab">
      ...
      <div style="display:flex; align-items:center; gap:0.5rem">
        <div class="header-badge energy" title="XP Points Badge">
          <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" style="vertical-align:middle; margin-right:2px"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
          <span id="score-count" style="font-family:var(--font-header); font-weight:800">0</span>
        </div>

        <button class="btn-icon" id="theme-toggle" title="Toggle Light/Dark Theme">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" class="sun-icon">
        ...
        <button class="btn-icon" id="audio-toggle" title="Toggle Sound">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M11 5L6 9H2v6h4l5 4V5z"/>
            <path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"/>
          </svg>
        </button>
        <button class="btn-icon" id="restart-course" title="Reset Progress">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <nav class="mobile-navbar" id="mobile-navbar">
    <button class="mobile-nav-btn" data-target="home-view" title="Home">
      <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
      <span>Home</span>
    </button>
    <button class="mobile-nav-btn" data-target="course-map-view" title="Course">
    ...
    <button class="mobile-nav-btn" data-target="explorer-view" title="Explorer">
    ...
    <button class="mobile-nav-btn" data-target="sandbox-view" title="Sandbox">
      <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>
      <span>Sandbox</span>
    </button>
    <button class="mobile-nav-btn" data-target="subnetting-view" title="Subnetting">
      <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
      <span>Subnet</span>
    </button>
    <button class="mobile-nav-btn" data-target="encoder-view" title="Signal Lab">
  ...
  <main>
    ...
    <!-- ══════════════════════════════════════════════════
         VIEW 1A: Course Map (Learning Path)
    ══════════════════════════════════════════════════ -->
    <section class="view-panel course-map-view" id="course-map-view">
      <div id="course-map-container"></div>
    </section>


    <!-- ══════════════════════════════════════════════════
         VIEW 1B: Guided Course (Lesson Details)
    ══════════════════════════════════════════════════ -->
    <section class="view-panel course-view">
      <div class="course-left">
        <div class="progress-bar-container">
          <button class="close-lesson" id="back-to-map-btn" title="Back to Learning Path">&larr;</button>
          <div class="progress-track" id="course-progress"></div>
          <select id="lesson-select" class="lesson-select" title="Jump to Lesson"></select>
          <div class="energy-badge" title="XP Points">
            <svg viewBox="0 0 24 24"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
            <span id="score-count">0</span> XP
          </div>
        </div>

        <div class="lesson-card">
          <h2 class="lesson-title" id="lesson-title">Loading Lesson…</h2>
          <div class="lesson-text" id="lesson-text">Please wait while the course materials load…</div>
          <div class="quiz-options" id="quiz-options"></div>
          <div class="feedback-alert" id="quiz-feedback"></div>
          <div class="course-footer">
            <button class="btn-primary" id="cta-btn" disabled>Check Answer</button>
          </div>
        </div>
      </div>

      <div class="course-right" id="course-sim-container"></div>
    </section>

    <!-- ══════════════════════════════════════════════════
         VIEW 2: Gate Explorer
    ══════════════════════════════════════════════════ -->
    <section class="view-panel explorer-view">
      <div class="explorer-sidebar" id="explorer-sidebar"></div>
      <div class="explorer-content">
        <div>
          <h2 class="lesson-title" id="exp-gate-title" style="font-size:2rem;margin-bottom:.5rem">AND Gate</h2>
          <p class="lesson-text" id="exp-gate-desc" style="margin-bottom:0">AND outputs 1 if both inputs are 1.</p>
        </div>
        <div class="explorer-grid-layout">
          <div class="explorer-sim-box" id="explorer-sim-box"></div>
          <div style="display:flex;flex-direction:column;gap:1.5rem">
            <div class="truth-table-card">
              <h3 style="font-family:var(--font-header);font-size:1.25rem">Truth Table</h3>
              <table class="truth-table" id="exp-truth-table"></table>
            </div>
          </div>
        </div>
        <div class="transistor-details-card" id="exp-transistor-desc"></div>
        <div class="transistor-details-card" id="exp-universality-desc" style="display:none;margin-top:1rem;border-color:var(--color-cyan)"></div>
      </div>
    </section>

    <!-- ══════════════════════════════════════════════════
         VIEW 3: Sandbox Circuit Builder
    ══════════════════════════════════════════════════ -->
    <section class="view-panel sandbox-view">
      <div class="sandbox-toolbox">
        <h3 style="font-family:var(--font-header);font-size:1.2rem;border-bottom:1px solid var(--border-color);padding-bottom:.5rem;margin-bottom:.5rem">Toolbox</h3>
        <p style="font-size:.85rem;color:var(--text-muted);line-height:1.4;margin-bottom:1rem">Drag onto canvas or click to place. Connect by clicking output → input port.</p>

        <div class="toolbox-section">
          <div class="toolbox-section-title">Inputs</div>
          <div class="toolbox-item" data-type="input"  draggable="true" title="Toggle Switch"><svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/></svg><span>Toggle Switch</span></div>
          <div class="toolbox-item" data-type="clock"  draggable="true" title="Clock Signal"><svg viewBox="0 0 24 24"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"/></svg><span>Clock Signal</span></div>
        </div>

        <div class="toolbox-section">
          <div class="toolbox-section-title">Logic Gates</div>
          <div class="toolbox-item" data-type="and"  draggable="true"><svg viewBox="0 0 24 24"><path d="M19 13H5v-2h14v2z"/></svg><span>AND Gate</span></div>
          <div class="toolbox-item" data-type="or"   draggable="true"><svg viewBox="0 0 24 24"><path d="M19 13H5v-2h14v2z"/></svg><span>OR Gate</span></div>
          <div class="toolbox-item" data-type="not"  draggable="true"><svg viewBox="0 0 24 24"><path d="M19 13H5v-2h14v2z"/></svg><span>NOT Gate</span></div>
          <div class="toolbox-item" data-type="nand" draggable="true"><svg viewBox="0 0 24 24"><path d="M19 13H5v-2h14v2z"/></svg><span>NAND Gate</span></div>
          <div class="toolbox-item" data-type="nor"  draggable="true"><svg viewBox="0 0 24 24"><path d="M19 13H5v-2h14v2z"/></svg><span>NOR Gate</span></div>
          <div class="toolbox-item" data-type="xor"  draggable="true"><svg viewBox="0 0 24 24"><path d="M19 13H5v-2h14v2z"/></svg><span>XOR Gate</span></div>
          <div class="toolbox-item" data-type="xnor" draggable="true"><svg viewBox="0 0 24 24"><path d="M19 13H5v-2h14v2z"/></svg><span>XNOR Gate</span></div>
        </div>

        <div class="toolbox-section">
          <div class="toolbox-section-title">Outputs</div>
          <div class="toolbox-item" data-type="output" draggable="true" title="LED Light">
        ...
        <div class="toolbox-section">
          <div class="toolbox-section-title">Compound Circuits</div>
          <div class="toolbox-item" data-type="half-adder" draggable="true" title="Half Adder">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M7 8l2 4-2 4M15 8h2"/></svg>
            <span>Half Adder</span>
          </div>
          <div class="toolbox-item" data-type="full-adder" draggable="true" title="Full Adder">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M7 8l2 4-2 4M14 8l2 4-2 4"/></svg>
            <span>Full Adder</span>
          </div>
        </div>

        <div class="toolbox-section">
          <div class="toolbox-section-title">Advanced</div>
          <div class="toolbox-item" data-type="d-flop" draggable="true" title="D Flip-Flop">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M7 12h4M15 8v8"/></svg>
            <span>D Flip-Flop</span>
          </div>
          <div class="toolbox-item" data-type="seven-seg" draggable="true" title="7-Segment Display">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 7h6M9 12h6M9 17h6"/></svg>
            <span>7-Seg Display</span>
          </div>
          <div class="toolbox-item" data-type="text-label" draggable="true" title="Text Label">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 7V5h16v2M9 20h6M12 5v15"/></svg>
            <span>Text Label</span>
          </div>
        </div>

        <!-- Prebuilt Circuit Templates -->
        <div class="toolbox-section" style="margin-top:0.5rem">
          <div class="toolbox-section-title" style="display:flex;align-items:center;gap:0.35rem">
            <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>
            Templates
          </div>
          <div style="font-size:0.68rem;color:var(--text-muted);margin-bottom:0.35rem;padding:0 2px;">
      ...
      <div class="sandbox-workspace" id="sandbox-workspace-canvas">
        <svg class="wires-svg" id="sandbox-wires-svg"></svg>
        <div class="sandbox-toolbar">
          <button class="sandbox-btn btn-play" id="sandbox-play" title="Run / Pause">
          ...
          <button class="sandbox-btn" id="sandbox-clear" title="Clear Canvas">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M19 6l-1 14H6L5 6M10 6V4h4v2"/></svg> Clear
          </button>
          <button class="sandbox-btn" id="sandbox-save" title="Save Circuit">
          ...
          <button class="sandbox-btn" id="sandbox-load" title="Load Circuit">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg> Load
          </button>
          <div style="width:1px;background:var(--border-color);height:20px"></div>
          <button class="sandbox-btn" id="sandbox-export" title="Export JSON">
          ...
          <button class="sandbox-btn" id="sandbox-import-btn" title="Import JSON">
          ...
          <div style="width:1px;background:var(--border-color);height:20px"></div>
          <button class="sandbox-btn" id="sandbox-theory-btn" title="Toggle Theory Guide">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg> Theory Guide
          </button>
          <input type="file" id="sandbox-import-file" accept=".json" style="display:none">
        </div>

        <!-- Floating Interactive Theory Guide Card -->
        <div class="sandbox-learning-card collapsed" id="sandbox-learning-card" style="display: none;">
          <div class="learning-card-header" id="learning-card-header">
            ...
            <div class="learning-card-controls">
              <button class="learning-card-btn" id="collapse-learning-card" title="Minimize/Expand">
                <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"><polyline points="4 14 10 14 10 20"></polyline><polyline points="20 10 14 10 14 4"></polyline></svg>
              </button>
              <button class="learning-card-btn" id="close-learning-card" title="Close Panel">&times;</button>
            </div>
          </div>
          <div class="learning-card-body" id="learning-card-body">
      ...
      <!-- Logic View Modal -->
      <div class="success-modal-overlay" id="logic-modal">
        <div class="success-modal" style="max-width:640px;width:92%;padding:2rem">
          <h2 class="success-modal-title" id="logic-modal-title" style="font-size:1.4rem;text-align:left;margin-bottom:0">Gate-Level Logic Inside</h2>
          <div id="logic-modal-content" style="margin:1.25rem 0;width:100%;display:flex;justify-content:center;align-items:flex-start;flex-direction:column"></div>
          <div style="display:flex;justify-content:flex-end">
            <button class="btn-primary" style="width:auto;padding:.6rem 1.5rem;border-radius:6px;flex:0" id="close-logic-modal">Close</button>
          </div>
        </div>
      </div>

      <!-- Save Modal -->
      <div class="success-modal-overlay" id="save-modal" style="display:none">
        <div class="success-modal" style="max-width:400px;padding:2rem;text-align:left">
          <h2 class="success-modal-title" style="font-size:1.2rem;margin-bottom:1rem">Save Circuit</h2>
          <input type="text" id="save-circuit-name" placeholder="Enter circuit name…"
            style="width:100%;padding:.6rem .75rem;border-radius:5px;border:1px solid var(--border-color);background:var(--bg-primary);color:var(--text-primary);font-family:var(--font-sans);font-size:.95rem;margin-bottom:1rem;outline:none">
          <div style="display:flex;gap:.5rem;justify-content:flex-end">
            <button class="btn-secondary" id="cancel-save-btn" style="flex:0;padding:.6rem 1.25rem">Cancel</button>
            <button class="btn-primary"   id="confirm-save-btn" style="flex:0;padding:.6rem 1.5rem">Save</button>
          </div>
        </div>
      </div>

      <!-- Load Modal -->
      <div class="success-modal-overlay" id="load-modal" style="display:none">
        <div class="success-modal" style="max-width:420px;padding:2rem;text-align:left">
          <h2 class="success-modal-title" style="font-size:1.2rem;margin-bottom:1rem">Load Circuit</h2>
          <div id="saved-circuits-list" style="max-height:280px;overflow-y:auto;border:1px solid var(--border-color);border-radius:6px;background:var(--bg-primary)"></div>
          <div style="display:flex;justify-content:flex-end;margin-top:1rem">
            <button class="btn-secondary" id="cancel-load-btn" style="flex:0;padding:.6rem 1.25rem">Close</button>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- ══════════════════════════════════════════════════
         VIEW 4: Subnetting Master
    ══════════════════════════════════════════════════ -->
    <section class="view-panel subnetting-view">
      <div class="util-view-header">
        <div class="util-view-badge"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-right:5px"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg> A/L ICT Networking</div>
        <h1 class="util-view-title">Subnetting Master</h1>
        <p class="util-view-subtitle">Learn the mental math patterns to solve network subnetting questions instantly.</p>
      </div>
      ...
      <div class="sn-container">
        ...
        <div class="sn-left">
          ...
          <div class="util-card">
            <div class="util-card-header">
              <div class="util-card-icon" style="background:rgba(6,182,212,0.15)"><svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#06b6d4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg></div>
              <div>
                <div class="util-card-title">Interactive CIDR Visualizer</div>
                <div class="util-card-sub">Class A / B / C Support</div>
              </div>
            </div>
            ...
            <div class="sn-metrics">
              ...
              <div class="sn-metric-card"><div class="sn-metric-title">Subnets in Octet</div><div class="sn-metric-value" id="sn-val-subnets">1</div></div>
              <div class="sn-metric-card"><div class="sn-metric-title">Usable Hosts</div><div class="sn-metric-value" id="sn-val-hosts">254</div></div>
            </div>
          </div>
          ...
          <div class="util-card">
            <div class="util-card-header">
              <div class="util-card-icon" style="background:rgba(139,92,246,0.15)"><svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#8b5cf6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="2" width="16" height="20" rx="2"/><line x1="8" y1="6" x2="16" y2="6"/><line x1="8" y1="10" x2="16" y2="10"/><line x1="8" y1="14" x2="12" y2="14"/></svg></div>
              <div>
                <div class="util-card-title">IP Subnet Block Finder</div>
                <div class="util-card-sub">Type an IP to locate its subnet block</div>
              </div>
            </div>
            <div class="sn-input-group">
              <input type="text" id="sn-ip-address-input" value="192.168.1.150" placeholder="e.g. 10.50.2.10 or 172.16.80.5">
            ...
            <div class="sn-block-list" id="sn-block-container"></div>
          </div>

          <!-- Cheat Table -->
          <div class="util-card">
            <div class="util-card-header">
              <div class="util-card-icon" style="background:rgba(16,185,129,0.15)"><svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#10b981" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg></div>
              <div>
                <div class="util-card-title">CIDR Reference Cheat Table</div>
                <div class="util-card-sub">Dynamic for the active Class block</div>
              </div>
            </div>
            <table class="sn-table">
              <thead><tr><th>CIDR</th><th>Subnet Mask</th><th>Usable Hosts</th><th>Block Size</th></tr></thead>
              <tbody id="sn-cheat-table-body"></tbody>
            </table>
          </div>
        </div>
        ...
        <div class="sn-right">
          ...
          <div class="util-card">
            <div class="util-card-header">
              <div class="util-card-icon" style="background:rgba(245,158,11,0.15)"><svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#f59e0b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="18" x2="15" y2="18"/><line x1="10" y1="22" x2="14" y2="22"/><path d="M12 2a7 7 0 0 1 7 7c0 2.38-1.19 4.47-3 5.74V17H8v-2.26C6.19 13.47 5 11.38 5 9a7 7 0 0 1 7-7z"/></svg></div>
              <div>
                <div class="util-card-title">The Mental Subnetting Trick</div>
...
80 Mbps actual data</div>
  ...
  <div class="success-modal-overlay" id="success-modal" style="display:none">
    <div class="success-modal" id="success-modal-box" style="max-width:450px;padding:2.5rem;text-align:center;position:relative">
      <div class="success-icon" style="width:80px;height:80px;margin:0 auto 1.5rem;background:var(--bg-tertiary);border-radius:50%;display:flex;align-items:center;justify-content:center;color:var(--color-success)">
        <svg viewBox="0 0 24 24" width="40" height="40" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
          <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/>
        </svg>
      </div>
      <h2 class="success-modal-title" style="font-size:1.8rem;margin-bottom:.75rem;font-family:var(--font-header)">Course Completed!</h2>
      <p style="color:var(--text-secondary);line-height:1.6;margin-bottom:2rem;font-size:1rem">
        Incredible! You have mastered Digital Logic and Networking fundamentals. Try building your own circuits in the Sandbox!
      </p>
      <button class="btn-primary" id="close-success-modal" style="width:100%;padding:.75rem 1.5rem;border-radius:6px">Open Sandbox Canvas</button>
    </div>
  </div>
  ...
  <div class="success-modal-overlay" id="app-quiz-modal" style="display:none">
    <div class="success-modal app-quiz-modal-box" id="app-quiz-modal-box">
      ...
      <div class="quiz-modal-header">
        ...
        <div class="quiz-xp-badge">
          <svg viewBox="0 0 24 24" class="xp-icon"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
          <span id="quiz-modal-xp-gain">+0</span> XP
        </div>
      ...
      <div class="quiz-modal-body">
        ...
        <div id="quiz-modal-summary-step" style="display:none">
          ...
          <p class="quiz-modal-summary-text" id="quiz-modal-summary-text">You got 5/5 questions correct and earned 100 XP!</p>
  ...
  <footer class="global-footer">
    <p>&copy; 2024 LogicQuest. Interactive A/L ICT Platform</p>
  </footer>
</body>
</html>