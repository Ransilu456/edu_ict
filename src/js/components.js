...
import packetLabViewHtml from '../components/packet-lab-view.html?raw';
...
export function mountComponents() {
  ...
  if (main) {
    main.innerHTML = booleanHtml + binaryHtml + sandboxViewHtml + icTesterViewHtml + networkViewHtml  + packetLabViewHtml;
