/**
 * LogicQuest — i18n Translation Module
 * Covers every piece of UI text in index.html, settings.js, app.js, and all views.
 * Usage:  import { t, applyLanguage, getCurrentLang } from './i18n.js';
 */
...
/**
 * Apply language to every translatable DOM element.
 * Elements use data-i18n="key" for text content,
...
export default { t, applyLanguage, getCurrentLang, TRANSLATIONS };